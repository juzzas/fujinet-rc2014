...
;        fujinet_hal_tx(frame.raw[i]);
    ; hl = command frame header from dcb
    push ix
    pop hl
    ld bc, 4
    call tx_buff

;        fujinet_hal_tx(fujinet_checksum((uint8_t *)&frame, 4));
    push ix
    pop hl
    ld bc, 4
...
;    }
    ...
    call fujinet_hal_rx_avail_timeout

    cp 0
    jp z, exec_exit_TIMEOUT
