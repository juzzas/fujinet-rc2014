; Based on code from https://github.com/RC2014Z80/RC2014/blob/master/BASIC-Programs/hexload/hexload.asm
...
endload:
            ...
            ld hl,loadokstr
            call print
            ld hl,0           ; CommandResult = COMMAND_SUCCESS
            ret

invtype:
            ld hl,invalidtypestr
            call print
            ld hl,3           ; CommandResult = COMMAND_ERROR_INVALID_DATA
            ret
